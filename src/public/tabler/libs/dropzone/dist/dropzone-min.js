!(function () {
  ...
  function s(e, i) {
    return !i || ("object" != ((n = i) && n.constructor === Symbol ? "symbol" : typeof n) && "function" != typeof i)
      ? t(e)
      : i;
    var n;
  }
      ...
      function o(n, r) {
        ...
        return (
          l.options.acceptedMimeTypes &&
            ((l.options.acceptedFiles = l.options.acceptedMimeTypes), delete l.options.acceptedMimeTypes),
            ...
            },
            {
              ...
              value: function (e, t, i, n, r) {
                ...
                return this.createThumbnail(e, t, i, n, !0, function (t, i) {
                  ...
                  return (
                    ("image/jpeg" !== n && "image/jpg" !== n) || (l = g.restore(e.dataURL, l)), r(o.dataURItoBlob(l))
                  );
                });
              },
            },
              ...
              value: function (e) {
                ...
                this._transformFiles(e, function (i) {
                  if (t.options.chunking) {
                    var n = i[0];
                    (e[0].upload.chunked =
                      t.options.chunking && (t.options.forceChunking || n.size > t.options.chunkSize)),
                  ...
                  if (e[0].upload.chunked) {
                    ...
                    for (u = 0; u < e.length; u++)
                      c[u] = { name: t._getParamName(u), data: i[u], filename: e[u].upload.filename };
                    t._uploadData(e, c);
                  }
                });
              },
                ...
                if (this.options.binaryBody) {
                  ...
                  if (this.options.params) {
                    ...
                    for (var w in ("function" == typeof k &&
                      (k = k.call(this, t, l, t[0].upload.chunked ? this._getChunk(t[0], l) : null)),
                    k)) {
                      var F = k[w];
  ...
  (f.createElement = function (e) {
    ...
    (f.getElement = function (e, t) {
      ...
      if (("string" == typeof e ? (i = document.querySelector(e)) : null != e.nodeType && (i = e), null == i))
        throw new Error(
          "Invalid `".concat(t, "` option provided. Please provide a CSS selector or a plain HTML element.")
        );
      return i;
    }),
